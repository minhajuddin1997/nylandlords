...
<head>
    ...
    <style>
        .table-responsive, .table_id_wrapper {
            overflow:auto;
        }
    </style>
</head>

<body id="print_view" style="background-image: url('<?php echo base_url('uploads/developer/').$this->admin_m->get_single_field('developer','','developer_content_image');?>');background-size:cover;">
