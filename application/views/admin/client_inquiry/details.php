<div class="content">
    ...
    border: 1px solid #ddd;
								        ...
								        .table > thead > tr > th { text-align:left; padding:10px 15px;border-right: 1px solid #ddd;}
	...
	<div class="container-fluid p_m">
		...
		<div class="col-md-12 p_m">
			...
			<?php if(!empty($records)): foreach($records as $record): ?>
							...
							<div class="box-body">
								<table class="table">
									...
									<tbody>
										...
										<tr>
											<td><b>Inquiry Appointment Start Time</b></td>
											<td><?php echo $record->appointment_start_time;?></td>
										</tr> 

										<tr>
											<td><b>Inquiry Appointment End Time</b></td>
											<td><?php echo $record->appointment_end_time;?></td>
										</tr> 
										...
										<tr>
											...
											<td>
											    <a href="<?php echo base_url('uploads/client_inquiry/').$record->summary_file; ?>" download>
											        <?php echo $record->summary_file;?></a>
											 </td>
										</tr>
                                        <tr>
                                            <td><b>Signature</b></td>
                                            <td><img src="<?php echo $record->signature_path;?>" style="width: 100px"> </td>
                                        </tr>
				...
				<div class="col-md-8 p_m">
				<form method="post" action="<?php echo base_url('admin/reply_comment')?>" enctype="multipart/form-data" >
			...
			<?php if(!empty($comments)): foreach($comments as $com): ?>
				<div class="row p_m" style="border-radius:4px;border:1px solid #cbcfcd;background-color: <?php echo ($com->sender_id != $this->session->userdata('user_id'))? '#20e88421':'#9143431a'?>">
					<div class="col-md-1">
						...
						<div class="col-md-11">
							<div class="dis-box">
								<div>
									...
									<div class="row">
										<?php $i=1; if(!empty($dataimages)): foreach($dataimages as $img): ?>
										...
										<div style="margin-top:11px;margin-bottom:11px;" class="col-sm-2">
											...
											<a href="<?php echo base_url('uploads/comments_images/').$img->comments_images_img;?>" download>
												<img style="padding:5px;border-radius:5px;border:1px solid #c5cbcc" class="img-responsive" src="<?php echo base_url('uploads/comments_images/').$img->comments_images_img;?>">
											</a>
									...
									<div class="row">
										<?php $i=1; if(!empty($datafiles)): foreach($datafiles as $file): ?>
										...
										<div style="margin-top:11px;margin-bottom:11px;" class="col-sm-2">
											...
											<span><?php echo substr($file->comments_files_file,0,20); ?></span>
										</div>
										<?php if($i == 5): ?>
											<?php $i = 0;?>
											<div class="row"></div>
