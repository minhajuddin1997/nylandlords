      ...
      <form role="form" action="<?php echo site_url('update_data/settings/'.$record->settings_id.'');?>" method="post" enctype="multipart/form-data">           
        <div class="box-body"> 
          ...
          <div class="form-group">
            ...
            <div class="input-group-btn">
              <div class="image-upload">                      
                <img class="imgpath" src="<?php echo !empty($record->email_logo)?base_url('uploads/settings/').$record->email_logo:base_url('assets/img/placeholder.png')?>">
                <div class="file-btn">
                  <input type="text" class="imageselect btn" value="<?php echo $record->email_logo;?>" id="email_logo" data-toggle="modal" data-target="#exampleModal" name="email_logo" value="<?php echo $record->email_logo;?>" readonly>
                  <label for="email_logo" class="btn btn-info">Upload</label>
                </div>
              </div>
            </div>
            <?php echo form_error("email_logo"); ?>
          </div>
