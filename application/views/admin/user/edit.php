    ...
    <div class="card">
            ...
            <form role="form" action="<?php echo base_url('admin/admin_update_password');?>" method="post" enctype="multipart/form-data"> 
                ...
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="content">
                            <form role="form" action="<?php echo base_url('update_data/user/').$this->session->userdata('user_id');?>" method="post" enctype="multipart/form-data"> 
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="user_phone" class="form-control" placeholder="User Phone" value="<?php echo !empty($record->user_phone)?$record->user_phone:''?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                       ...
                                       <div class="form-group">
                                        ...
                                        <div class="input-group-btn">
                                          <div class="image-upload">                      
                                            <img class="imgpath" src="<?php echo !empty($record->user_image)?base_url('uploads/user/').$record->user_image:base_url('assets/img/placeholder.png')?>">
                                            <div class="file-btn">
      ...
      <div class="col-md-4">
        <div class="card card-user">
            <div class="image">
                <img src="<?php echo base_url(); ?>uploads/developer/background.jpg" alt="...">
            </div>
            <div class="content">
                <div class="author">
                 <a href="#">
                    <img class="avatar border-gray" src="<?php echo (!empty($record->user_image))? base_url('uploads/user/').$record->user_image :base_url('assets/img/unisex.png');?>" alt="...">
