    ...
    <div class="container-fluid">
      <div id="main-div">
        <header class="clearfix">
          ...
          <div style="font-size:14px" id="company">
        ...
        <main>
          <div id="details" class="clearfix">
            <div id="client">
              ...
              <p style="font-size:12px;">
                  ...
                  2- Complete project terms are mentioned in approved proposal document.
          ...
          <?php $projectdata = $this->admin_m->get_list_single('client_inquiry',array('client_inquiry_id'=>$record->inquiry_id));
          ...
          <table border="0" cellspacing="0" cellpadding="0">
            <thead>
              <tr>
                <th class="no">#</th>
                <th class="desc">Package Details</th>
                
                <th class="qty"></th>
                <th class="total">Inquiry Price</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td class="">01</td>
                <td class="det"><h3><?php echo $projectdata->inquiry_name; ?></h3>
                  <label>- Inquiry Type: <?php echo get_name_by_id("department",$projectdata->inquiry_type)?></label>
                  <label>- Inquiry Summary: <?php echo $projectdata->inquiry_summary; ?></label>
                  <label>- Delivery Status: <?php echo $projectdata->delivery_status; ?></label>
                  
                  
                  
                  <td class="cen"></td>
                  <td class="cen">$<?php echo $projectdata->inquiry_price;?></td>
                </tr>
                </tbody>
                <tfoot>
                  ...
                  <tr style="border-bottom:1px solid #e4e3e3 !important">
                    ...
                    <th class="sub ">$<?php echo $projectdata->inquiry_balance; ?></th>
                  </tr>
                  <tr>
                    <th class="tp"></th>
