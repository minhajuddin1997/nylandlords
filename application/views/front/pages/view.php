        ...
        <div class="col-12">
          <div class="invoice p-3 mb-3">
            ...
            <div class="row">
              ...
              <?php $money = $this->admin_m->sum_money('order_items_total_amt',array('orders_id'=>$record->orders_id));?>
              <?php $discount_money = $this->admin_m->sum_money_order('orders_diss_amt',array('orders_id'=>$record->orders_id));?>
              <div class="col-6">
