...
$charge = \Stripe\Charge::create(array('amount' => 2000, 'currency' => 'cad', 'source' => 'tok_189fqt2eZvKYlo2CTGBeg6Uq' ));
echo $charge;
```
...
$charge = Stripe_Charge::create(array('source' => 'tok_XXXXXXXX', 'amount' => 2000, 'currency' => 'cad'));
echo $charge;
```
